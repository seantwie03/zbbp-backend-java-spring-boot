-- CategoryGroups
INSERT INTO category_groups (id, name, budget_date, version, created_at)
VALUES (1,
        'Incomes',
...
-- Categories
INSERT INTO categories (id, name, budget_date, planned_amount, category_group_id, version, created_at)
VALUES (1,
        'Primary Income',
        make_date(extract(year FROM current_date)::int, extract(month FROM current_date)::int, 01),
        800.00,
...
-- Transactions
INSERT INTO transactions (id, description, date, amount, is_deposit, version, created_at)
VALUES (1,
